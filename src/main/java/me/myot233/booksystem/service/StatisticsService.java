...
public class StatisticsService {
    ...
    public Map<String, Object> getSystemStatistics() {
        ...
        // 今日借阅统计
        stats.put("todayBorrowCount", bookService.getTodayBorrowCount());
        
        // 在线用户数
        stats.put("onlineUserCount", bookService.getOnlineUserCount());
        
        // 热门图书
        stats.put("hotBooks", bookService.getHotBooks(5));
    ...
    public Map<String, Object> getRealtimeSystemStatus() {
        ...
        // 当前活跃连接数
        status.put("activeConnections", bookService.getOnlineUserCount());
        
        // 今日系统负载（基于借阅次数）
        Long todayBorrows = bookService.getTodayBorrowCount();
